# Pi-to-Pi v1 Protocol

## Purpose

Define the authoritative, transport-independent v1 contract for authenticated, explicitly correlated, bounded, and retry-safe Pi-to-Pi operations and task delivery.
